...
cursor.execute("CREATE TABLE IF NOT EXISTS pours (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, tap int(6), timestamp TIMESTAMP, account int(6), stolen BOOLEAN)")
